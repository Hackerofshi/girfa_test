...
Java_com_android_grafika_utils_YUVUtils_test(JNIEnv *env, jobject thiz) {
    LOGD("-------------");
}

extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_android_grafika_utils_YUVUtils_rotateYuv90(JNIEnv *env,
                                                    jclass instance,
                                                    jbyteArray yuv420p,
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_android_grafika_utils_YUVUtils_rotateYUVDegree270AndMirror(JNIEnv *env, jclass type,
                                                                    jbyteArray nv21_,
                                                                    jint imageWidth,
                                                                    jint imageHeight) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_android_grafika_utils_YUVUtils_setBitmapBits(JNIEnv *env,
                                                      jobject instance,
                                                      jbyteArray bgr_,
                                                      jint width,
                                                      jint height) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_NV21ToNV12(JNIEnv *env, jclass type, jbyteArray nv21_,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_NV21ToI420(JNIEnv *env, jclass type,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_RotateI420(JNIEnv *env, jclass type,
                                                   jbyteArray input_, jbyteArray output_,
                                                   jint width, jint height,
                                                   jint rotation) {
    jbyte *input = env->GetByteArrayElements(input_, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_NV21RotateAndConvertToNv12(JNIEnv *env,
                                                                   jclass type,
                                                                   jbyteArray input_,
                                                                   jbyteArray output_,
                                                                   jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_NV21RotateAndMirrorConvertToNv12(JNIEnv *env,
                                                                         jclass type,
                                                                         jbyteArray input_,
                                                                         jbyteArray output_,
                                                                         jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_NV21ToARGB(JNIEnv *env, jclass type,
                                                   jbyteArray input_, jbyteArray output_,
                                                   jint width, jint height) {
    jbyte *input = env->GetByteArrayElements(input_, NULL);
    jbyte *output = env->GetByteArrayElements(output_, NULL);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_android_grafika_utils_YUVUtils_ARGBToNV21(JNIEnv *env, jclass type,
                                                   jbyteArray input_, jbyteArray output_,
                                                   jint width, jint height) {
    jbyte *input = env->GetByteArrayElements(input_, NULL);
    jbyte *output = env->GetByteArrayElements(output_, NULL);
