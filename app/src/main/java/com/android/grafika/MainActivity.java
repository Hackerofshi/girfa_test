...
public class MainActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        long totalSize1 = SDCardUtils.getTotalSize(Environment.getExternalStorageDirectory().getAbsolutePath());
        long sdAvailableSize1 = SDCardUtils.getAvailableSize(Environment.getExternalStorageDirectory().getAbsolutePath());
        Log.d(TAG, "totalSize1: " + (totalSize1 / 1024 / 1024 / 1024));
        Log.d(TAG, "sdAvailableSize1: " + sdAvailableSize1);
